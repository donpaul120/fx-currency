package com.fx.exchange_experiment.core.utils
...
object CurrencyUtil {
    ...
    //since currencies code mostly never changes we can have them here
    ...
    fun getCurrencies() : List<Currency> {
        return currencies.map { Currency(it.value, it.key) }
    }

    fun getCurrencyByCode(code: String) : Currency? {
        val name = currencies[code];
        return if(name != null) Currency(name = name, code = code.uppercase()) else null
    }
